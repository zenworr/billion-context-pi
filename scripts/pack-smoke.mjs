...
function pack(workspace) {
  const result = JSON.parse(runNpm(["pack", "--json", "--pack-destination", packs, "-w", workspace]));
...
try {
  ...
  runNpm(["install", "--ignore-scripts", extensionTarball, "typescript@5.9.3", "@earendil-works/pi-coding-agent@^0.84.1", "typebox"], consumer);
